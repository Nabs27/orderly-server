...
class _CartPageState extends State<CartPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      // 🆕 Utiliser tableState si disponible pour synchronisation
      final tableState = data['tableState'] as Map<String, dynamic>?;
      if (tableState != null) {
        print('[CART] 📊 État de la table reçu: ${tableState['totalOrders']} commande(s), total: ${tableState['totalAmount']} TND');
        // L'app peut maintenant afficher toutes les commandes de la table
        // et voir immédiatement les commandes POS existantes
      }
