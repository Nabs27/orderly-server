...
class CreditReportService {
  static const _adminTokenHeader = {'x-admin-token': 'admin123'};
  ...
  static Future<CreditReport> loadReport({
    ...
    final response = await ApiClient.dio.get(
      ...
      options: Options(headers: _adminTokenHeader),
    );
  ...
  static String buildTicketUrl({
    ...
    final queryParams = <String, String>{
      ...
      'dateTo': to.toIso8601String(),
      'period': period,
      'x-admin-token': _adminTokenHeader['x-admin-token']!,
    };
